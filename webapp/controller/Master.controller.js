sap.ui.define([
	...
	return BaseController.extend("com.demoEquipe.zdemo_equipe.controller.Master", {
...
alert("bonne vacances");
		...
		onSearch : function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("SupplName", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "com.demoEquipe.zdemo_equipe.view.ViewSettingsDialog",
					controller: this
